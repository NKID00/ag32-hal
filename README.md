...
Rust HAL (Hardware Abstraction Library) for the mysterious AG32VF303xCx6 microcontroller and FPGA combo chip from AGM.

AG32VF303xCx6 features 128K SRAM, 256K Flash, a RV32IMAFC CPU up to 248MHz and a built-in FPGA (namely AGRV2K) with 2K LUTs.
